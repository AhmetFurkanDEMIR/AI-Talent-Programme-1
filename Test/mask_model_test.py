...
net = cv2.dnn.readNetFromCaffe("deploy.prototxt.txt", "res10_300x300_ssd_iter_140000.caffemodel") # yüz tespiti modelleri

vs = VideoStream(src=0).start() # kamera görüntüsü
time.sleep(2.0)

model = load_model("mask_model.h5") # maske tespiti modeli
